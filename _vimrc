...
autocmd BufEnter *.dis set iskeyword+=`
...
function! s:OpenCommitInLog()
  ...
  norm zz
  call s:CheckForPositionChange(0)
endfunction
...
nnoremap <silent> <A-t> :silent :call<SID>OpenCommitInLog()<CR>
" nmap <silent> <A-t> N
...
nnoremap <A-c> :silent !c.cmd <C-r>=expand('%:p').':'.line('.')<CR><CR>
